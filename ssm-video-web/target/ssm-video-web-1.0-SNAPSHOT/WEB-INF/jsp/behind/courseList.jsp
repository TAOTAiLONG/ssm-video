    ...
    <table class="table table-bordered table-hover"
        ...
        <c:forEach items="${pageInfo.list}" var="course" varStatus="status">
            <tr>
                ...
                <td><a href="${pageContext.request.contextPath}/course/addCourse?id=${course.id}"><span
                        class="glyphicon glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>
                <td><a href="#" onclick="return delCourseById(this,'${course.id}','${course.courseTitle}')"><span
    ...
    <div style="width: 380px; margin: 0 auto; margin-top: 50px; text-align: center;">
        <ul class="pagination" style="margin-top: 10px;">
            ...
            <c:if test="${pageInfo.pageNum !=1 || pageInfo.pageNum == null }">
                <li>
                    <a href="${pageContext.request.contextPath }/course/showCourseList?pn=${1}"
                       aria-label="Previous">
                ...
                <li>
                    <a href="${pageContext.request.contextPath }/course/showCourseList?pn=${pageInfo.pageNum - 1}"
                       aria-label="Previous">
            ...
            <c:forEach begin="1" end="${pageInfo.pages}" varStatus="page">
                ...
                <c:if test="${pageInfo.pageNum != page.count }">
                    <li><a href="${pageContext.request.contextPath }/course/showCourseList?pn=${page.count}">${page.count }</a></li>
                </c:if>
            </c:forEach>

            <c:if test="${pageInfo.pageNum != pageInfo.pages || pageInfo.pageNum == null}">
                <li >
                    <a href="${pageContext.request.contextPath }/course/showCourseList?pn=${pageInfo.pageNum + 1}" aria-label="Next">
                        <span aria-hidden="true">&raquo;</span>
                    </a>
                </li>

                <li >
                    <a href="${pageContext.request.contextPath }/course/showCourseList?pn=${pageInfo.pages}" aria-label="Next">
