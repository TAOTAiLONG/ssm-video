        ...
        <table class="table table-bordered table-hover"
            ...
            <c:forEach items="${pageInfo.list}" var="video" varStatus="status">
                <tr>
                    ...
                    <td>
                        <c:forEach items="${speakerList}" var="speaker">
                            <c:if test="${speaker.id.equals(video.speakerId)}" >
                                ${speaker.speakerName}
                            </c:if>
                        </c:forEach>
                    </td>
    ...
    <div style="width: 380px; margin: 0 auto; margin-top: 50px; text-align: center;">
        <ul class="pagination" style="margin-top: 10px;">
            ...
            <c:if test="${pageInfo.pageNum !=1 || pageInfo.pageNum == null }">
                <li>
                    <a href="javascript:void(0)" onclick="queryVideo(1)"
                       aria-label="Previous">
                ...
                <li>
                    <a href="javascript:void(0)" onclick="queryVideo(${pageInfo.pageNum - 1})"
                       aria-label="Previous">
            ...
            <c:if test="${pageInfo.pageNum != pageInfo.pages || pageInfo.pageNum == null}">
                <li >
                    <a href="javascript:void(0)" onclick="queryVideo(${pageInfo.pageNum + 1})" aria-label="Next">
                        <span aria-hidden="true">&raquo;</span>
                    </a>
                </li>

                <li >
                    <a href="javascript:void(0)" onclick="queryVideo(${pageInfo.pages})" aria-label="Next">
